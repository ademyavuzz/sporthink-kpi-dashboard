...
ENDPOINTS = [
    ...
    ("GET", "/api/v1/segments",                    "read", None, [200], "admin.segments"),
    ("GET", "/api/v1/segments/rfm?date_from=2024-10-01&date_to=2025-03-31", "read", None, [200], "admin.segments_rfm"),
    ...
    ("POST",   "/api/v1/segments",               "noauth", {"name":"x"},               [401], "segments.create.noauth"),
    ...
    ("DELETE", "/api/v1/segments/9999999",       "noauth", None,                       [401], "segments.delete.noauth"),
    ...
    ("DELETE", "/api/v1/segments/9999999",       "validate", None,                      [404], "segments.delete(missing)"),
    ("PATCH",  "/api/v1/segments/9999999",       "validate", {"name":"x"},              [404], "segments.patch(missing)"),
